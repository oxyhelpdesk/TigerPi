...
certutil -N -d ~/.certs -f /home/pi/dd_script/certutil.txt; #encrpyts the certificate database
...
cat /home/pi/dd_script/account_settings.txt >> /etc/nail.rc; #adds the account settings
